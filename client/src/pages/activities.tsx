        ...
        <div className="flex gap-3 mb-12 overflow-x-auto pb-4 scrollbar-hide">
          {categories.map(cat => (
            <button
              ...
              className={`px-6 py-3 rounded-full whitespace-nowrap transition-all border font-bold text-md ${selectedCategory === cat.id
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            {(selectedCategory === 'all' || selectedCategory === 'journaling') && (
              ...
              >
                <div className="flex items-start justify-between mb-6">
                  <div className="w-16 h-16 rounded-2xl bg-indigo-50 flex items-center justify-center text-3xl group-hover:bg-indigo-100 transition-colors duration-300">
                    🎙️
                  </div>
                ...
                <div className="mb-auto">
                  <h3 className="text-2xl font-bold text-foreground mb-3 group-hover:text-indigo-600 transition-colors leading-tight">
                    Voice Journal
                  </h3>
                ...
                <div className="mb-6 rounded-2xl overflow-hidden bg-indigo-50/50 h-48 flex items-center justify-center border border-border group-hover:border-indigo-200 transition-colors">
            ...
            {displayActivities.map(activity => (
              ...
              >
                {/* Header */}
                <div className="flex items-start justify-between mb-6">
                  <div className={`w-16 h-16 rounded-2xl bg-secondary/30 flex items-center justify-center text-3xl group-hover:bg-secondary/60 transition-colors duration-300`}>
                    {activity.icon_emoji}
                  </div>
                ...
                {/* Animation Preview */}
                <div className="mb-6 rounded-2xl overflow-hidden bg-secondary/10 h-48 flex items-center justify-center border border-border group-hover:border-primary/20 transition-colors">
